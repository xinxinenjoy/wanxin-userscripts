 ...
 * - 报表可勾选批量查询，也可单独查询；勾选状态自动记忆，批量查询按顺序错开请求。
 * - 支持今天 / 本月 / 本季度 / 本年 / 自定义日期区间；体检对账报表支持超 1080 天自动分段。
 * - 查询结果分别展示、独立导出；客户加选项目报表为异步生成，支持 15 秒检测、重新获取与查看下载中心状态。
 * - 支持 Fly 授权自动获取、失效刷新、网络重试，可与对账报表同时使用。
 */
