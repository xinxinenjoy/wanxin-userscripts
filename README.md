...
当前正式发布 **15** 个脚本 · 最近修改 **2026-09-21 18:26**
...
| **扁鹊-1.1首页模块排序** | `4.7` | 2026-09-21 18:26 | SOA首页模块排序：支持网页原始顺序/脚本排序两种图标方案，并支持拖拽保存、列数、模块宽度及列间距设置。 | [⚡ 推荐安装](https://scripts.wanxinxin.dpdns.org/bianque/soa-shouye.user.js) · [GitHub 备用](https://raw.githubusercontent.com/xinxinenjoy/wanxin-userscripts/main/publish/bianque/soa-shouye.user.js) |
