...
当前正式发布 **13** 个脚本 · 最近修改 **2026-09-15 14:35**
...
| **扁鹊-1.6制卡管理查询** | `0.5.0` | 2026-09-15 14:35 | 查询并汇总本年度的贵宾、邀约、核磁、CT等制卡记录，按部门/人员统计办卡进度。 | [⚡ 推荐安装](https://scripts.wanxinxin.dpdns.org/bianque/soa-zhikaguanli.user.js) · [GitHub 备用](https://raw.githubusercontent.com/xinxinenjoy/wanxin-userscripts/main/publish/bianque/soa-zhikaguanli.user.js) |
